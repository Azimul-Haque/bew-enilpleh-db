...
class DoctorController extends Controller
{
    ...
    public function doctorSerialCancelSingle(Request $request)
    {
        ...
        $text = "Appointment Cancelled!\n\n" .
                "Dear " . $request->name . ", we are sorry to inform you that, your appointment with " . $serialdoctor->name . " on " . date('d-m-Y', strtotime($request->serialdate)) . " has been cancelled unfortunately.\n\n" .
