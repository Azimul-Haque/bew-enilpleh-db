        ...
        <div class="modal-content">
          ...
          <form method="post" action="{{ route('dashboard.doctors.store') }}" enctype="multipart/form-data">
            <div class="modal-body">
                  ...
                  <div style="margin-top: 15px;">
                    <input type="text" id="selected_offdays" name="selected_offdays[]" class="form-control" placeholder="যেদিন যেদিন রোগী দেখবেন না (প্রয়োজনে একাধিক সিলেক্ট করা যাবে) [Optional]" readonly>
