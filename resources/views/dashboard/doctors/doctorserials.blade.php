...
@section('content')
  @section('page-header') <a href="{{ route('dashboard.doctors.chambers', $doctor->id) }}">চেম্বার তালিকা</a> / {{ $doctor->name }}-এর অ্যাপয়েন্টমেন্ট তালিকা @endsection
    <div class="container-fluid">
      <div class="card">
            <div class="card-header">
              <h3 class="card-title">{{ $doctor->name }}-এর অ্যাপয়েন্টমেন্ট তালিকা (<strong>{{ bangla(date('d F Y', strtotime($todaydate))) }}</strong> ও তৎপরবর্তী)</h3>
              ...
              <div class="card-tools">
                <form class="form-inline form-group-lg" action="">
                  ...
                  <button type="button" class="btn btn-success btn-sm" style="margin-left: 5px;" title="সকলকে ক্যানসেল মেসেজ পাঠান" data-toggle="modal" data-target="#sendCancelSMSALLModal">
                   <i class="fas fa-print"></i> প্রিন্ট করুন
                  </button>
        ...
        <div class="modal-content">
          ...
          <form method="post" action="{{ route('dashboard.adddoctorserialmanually', [$doctor->id, $hospitalid, $todaydate]) }}" enctype="multipart/form-data">
            <div class="modal-body">
              ...
              <input type="text" class="form-control" name="serialdate" id="addserialdate" placeholder="তারিখ" placeholder="তারিখ সিলেক্ট করুন" readonly required><br/>
