                                ...
                                <form method="post" action="{{ route('dashboard.doctorserialcancelsingle', [$doctorserial->doctor_id, $todaydate]) }}" enctype="multipart/form-data">
                                  <div class="modal-body">
                                        ...
                                        <div class="input-group mb-3">
                                          <textarea name="message" class="form-control" style="min-height: 90px;" placeholder="মেসেজ লিখুন">Appointment Cancelled!&#10;&#10;Dear {{ $doctorserial->name }}, your appointment with {{ $doctorserial->doctor->name }} on {{ date('d-m-Y', strtotime($doctorserial->serialdate)) }} has been cancelled unfortunately.</textarea>
                                        </div>
                                  </div>
