...
@section('content')
  @section('page-header') <a href="{{ Auth::user()->role == 'admin' ? route('dashboard.doctors.chambers', $doctor->id) : '#!' }}">চেম্বার তালিকা</a> / {{ $doctor->name }}-এর অ্যাপয়েন্টমেন্ট তালিকা @endsection
