                    ...
                    <tbody>
                      ...
                      @foreach($doctorserials as $doctorserial)
                        <tr>
                          ...
                          <td align="right">
                           <button type="button" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" data-toggle="modal" data-target="#sendCancelSMSModal{{ $doctorserial->id }}">
