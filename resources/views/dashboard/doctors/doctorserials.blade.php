        ...
        <div class="modal-content">
          ...
          <form method="post" action="{{ route('dashboard.adddoctorserialmanually', [$doctor->id, $todaydate]) }}" enctype="multipart/form-data">
            <div class="modal-body">
              ...
              <input type="text" class="form-control" name="serialdate" id="addserialdate" placeholder="তারিখ" value="সিরিয়ালের তারিখ: {{ date('d-m-Y', strtotime($todaydate)) }}" readonly required><br/>
