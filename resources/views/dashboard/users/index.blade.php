              ...
              <tbody>
                ...
                @foreach($users as $user)
                	<tr>
                      ...
                      @if($user->role == 'doctor')<span class="badge bg-default">BM&DC রেজিস্ট্রেশন নম্বর: {{ $user->->accessibleDoctors()->first()->bmdc_number }}</span>@endif
            			        ...
            			        <div class="modal-content">
            			          ...
            			          <form method="post" action="{{ route('dashboard.users.update', $user->id) }}">
            				          <div class="modal-body">
                                        ...
                                        <option value="doctor" @if($user->role == 'doctor') selected="" @endif>ডাক্তার</option>
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <form method="post" action="{{ route('dashboard.users.activate', $user->id) }}">
                                ...
                                <div class="modal-footer">
                                  <button type="button" class="btn btn-secondary" data-dismiss="modal">ফিরে যান</button>
                                  <button type="submit" class="btn btn-warning">একটিভেট করুন</button>
                                </div>
                              </form>
                            </div>
                          </div>
