  ...
  @section('page-header') হাসপাতাল - ডাক্তার তালিকা ({{ $hospital->name }}) @endsection
    ...
    <div class="card">
          <div class="card-header">
            <h3 class="card-title">{{ $hospital->name }}-এর ডাক্তার তালিকা</h3>
                ...
                @foreach($hospital->doctorhospitals as $doctorhospital)
                  <tr>
                    ...
                    <td align="right">
                      ...
                      <a href="{{ route('dashboard.doctors.chambers', $doctorhospital->doctor->id) }}" style="margin-top: 5px;" class="btn btn-warning btn-sm">
