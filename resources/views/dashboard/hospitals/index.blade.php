          ...
          <form method="post" action="{{ route('dashboard.hospitals.store') }}">
            <div class="modal-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div style="margin-bottom: 15px;">
                        <select name="branch_ids[]" class="form-control multiple-select" multiple="multiple" data-placeholder="শাখা হাসপাতাল (প্রয়োজনে একাধিক সিলেক্ট করা যাবে)" style="margin-bottom: 15px;">
