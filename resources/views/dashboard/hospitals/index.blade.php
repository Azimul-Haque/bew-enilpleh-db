          ...
          <div class="card-header">
            ...
            <div class="card-tools">              
              <form class="form-inline form-group-lg" action="">
                ...
                <select id="districtsearch" class="form-control form-control-sm" data-placeholder="জেলা নির্বাচন করুন" style="margin-right: 10px;">
              ...
              <tbody>
                @foreach($hospitals as $hospital)
                  <tr>
                    ...
                    <td>
                      <span class="badge bg-{{ hospital_badge($hospital->hospital_type) }}">{{ hospital_type($hospital->hospital_type) }}</span></td>
                    <td>
                      {{ $hospital->address }}<br/>
