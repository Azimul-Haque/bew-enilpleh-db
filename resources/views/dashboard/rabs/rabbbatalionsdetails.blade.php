...
@section('content')
  @section('page-header') র‍্যাব ব্যাটালিয়ন / {{ $rabbattallion->name }} জেলা (মোট {{ bangla($rabbattallion->rabbattaliondetails->count()) }} টি) @endsection
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header bg-success">
            <h5 class="modal-title" id="addUserModalLabel">নতুন র‍্যাব অফিসার যোগ (জেলা: <strong>{{ $district->name_bangla }}</strong>)</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
