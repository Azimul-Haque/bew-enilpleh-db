                      ...
                      @foreach ($districts->chunk(3) as $chunk)
                          <tr>
                              @foreach ($chunk as $district)
                                  ...
                                  <td>
                                    <button type="button" class="btn btn-primary btn-sm"  data-toggle="modal" data-target="#addRabBattalionModal" style="margin-left: 5px;" rel="tooltip" title="" data-original-title="র‍্যাব ব্যাটালিয়ন সংযুক্ত করুন">
                                      <i class="fas fa-plus-square"></i> র‍্যাব সংযুক্ত
                                    </button>
                                  </td>
                              @endforeach
                              @if ($chunk->count() < 3)
