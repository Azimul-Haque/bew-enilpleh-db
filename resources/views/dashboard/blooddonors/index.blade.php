                  ...
                  <tr>
                    ...
                    <td>
                      @if($blooddonor->category == 2)
                        <a href="{{ route('dashboard.blooddonormembers', $blooddonor->id) }}" class="badge badge-warning" title="সদস্য যোগ করতে বা এডিট করতে ক্লিক করুন" class=""><big><strong>সদস্য তালিকা দেখুন ({{ $blooddonor->blooddonormembers->count() }})</strong></big></a>
                      @endif
                    </td>
                    <td>
