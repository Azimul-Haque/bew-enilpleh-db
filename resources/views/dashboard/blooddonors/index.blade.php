                  ...
                  <tr>
                    ...
                    <td>
                      @if($blooddonor->category == 2)
                        <a href="{{ route('dashboard.blooddonormembers', $blooddonor->id) }}" class="badge " title="সদস্য যোগ করতে বা এডিট করতে ক্লিক করুন" class=""><strong>সদস্য তালিকা দেখুন</strong></a>
                      @endif
                    </td>
                    <td>
