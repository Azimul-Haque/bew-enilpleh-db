    ...
    <div class="container-fluid">
      ...
      @if(Auth::user()->role != 'doctor')
        <div class="row">
          ...
          @if(Auth::user()->role == 'admin' || in_array('coachings', Auth::user()->accessibleCoachings()))
          <div class="col-md-3">
      ...
      <div class="row">
        <div class="col-md-3">
          <a href="{{ route('dashboard.doctors.profile', Auth::user()->accessibleDoctors()->first()->id) }}" class="info-box mb-3">
