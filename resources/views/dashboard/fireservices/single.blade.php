...
@section('content')
  @section('page-header') ফায়ার সার্ভিস কর্মকর্তা তালিকা / {{ $district->name_bangla }} জেলা (মোট {{ bangla($fireservicescount) }} টি) @endsection
    <div class="container-fluid">
    <div class="card">
          <div class="card-header">
            <h3 class="card-title">ফায়ার সার্ভিস কর্মকর্তা তালিকা</h3>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header bg-success">
            <h5 class="modal-title" id="addUserModalLabel">নতুন ফায়ার সার্ভিস কর্মকর্তা যোগ (জেলা: <strong>{{ $district->name_bangla }}</strong>)</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
            ...
            <div class="modal-body">
                  ...
                  <div class="input-group mb-3">
                      <input type="text"
                             ...
                             class="form-control"
                             value="{{ old('name') }}"
                             placeholder="ফায়ার সার্ভিস কর্মকর্তার পদবি (যেমন: সহকারী পরিচালক, টাংগাইল ফায়ার স্টেশন ইত্যাদি ইত্যাদি)" required>
                      <div class="input-group-append">
                          <div class="input-group-text"><span class="fas fa-user-tie"></span></div>
                      </div>
                  </div>
