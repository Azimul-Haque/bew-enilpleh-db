...
Route::get('/dashboard/doctors/{id}/profile', 'DoctorController@doctorProfile')->name('dashboard.doctors.profile');
Route::post('/dashboard/doctors/{id}/profile/update', 'DoctorController@updateDoctorProfile')->name('dashboard.doctors.profile.update');
...
Route::post('/dashboard/users/{id}/activate', 'DashboardController@activateUser')->name('dashboard.users.activate');
