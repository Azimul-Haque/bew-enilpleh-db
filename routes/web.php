...
Route::get('/dashboard/rentacars/{district_id}', 'AdminandothersController@busIndexSingle')->name('dashboard.buses.districtwise');
Route::get('/dashboard/rentacars/{district_id}/{search}', 'AdminandothersController@busIndexSearch')->name('dashboard.buses.districtwise.search');
Route::post('/dashboard/rentacars/{district_id}/store', 'AdminandothersController@storeBus')->name('dashboard.buses.store');
Route::post('/dashboard/rentacars/{district_id}/{id}/update', 'AdminandothersController@updateBus')->name('dashboard.buses.update');
Route::get('/dashboard/rentacars/{district_id}/{id}/delete', 'AdminandothersController@deleteBus')->name('dashboard.buses.delete');
