...
Route::get('/getdoctors/{softtoken}/{medicalitemid}/{district_id}', 'APIController@getHospitalsDistrict')->name('api.gethospitalsdistrict');
Route::get('/getdoctors/{softtoken}/{medicalitemid}/{district_id}/{upazilla_id}', 'APIController@getHospitalsUpazilla')->name('api.gethospitalsupazilla');
