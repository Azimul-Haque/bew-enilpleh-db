...
Route::post('/doctorserial/store', 'APIController@storeDoctorSerial')->name('api.storemessage');
...
Route::get('/getnewspapers/{softtoken}', 'APIController@getNewspapers')->name('api.getnewspapers');
